...
public class UNO {
    ...
    // GUI components
    private static UNOWindow window;
    ...
    private void handleHumanPlay(UNOCard card) {
    ...
    private void updateTopCard() {
        piles.updateTopCard(new UNOCard(currentCard));
    }

    private void updateDiscardPile() {
        UNOCard visualCard = new UNOCard(deck.getfirstcard());

...
public class ZCardButton extends JButton {
	...
	private static Dimension zoomedSize = new Dimension(88, 132);
	private boolean zoomEnabled = false; // Nouveau champ // +10%
	private static Timer zoomInTimer;
	private Timer zoomOutTimer;


	public void setZoomEnabled(boolean enabled) { // Nouvelle méthode
	...
	public ZCardButton(ImageIcon img) {
		...
		// Modifiez les listeners pour vérifier zoomEnabled
	...
	public void zoomOut() {
		zoomOutTimer = new Timer(20, new ActionListener() {
			int step = 0;
			public void actionPerformed(ActionEvent e) {
				step++;
	...
	protected void paintComponent(Graphics g) {
		...
		g2.fillRoundRect(10, 10, w - 20, h / 2 - 10, 0, 0);
